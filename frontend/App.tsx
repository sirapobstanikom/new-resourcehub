...
const GrowthFixedMindsetAssessment = lazy(() => import('./components/GrowthFixedMindsetAssessment'));
    ...
    return (
      <Suspense fallback={<RouteFallback />}>
        <Routes>
          ...
          />
          <Route
            path="/assessment/growth-fixed-mindset"
            element={<GrowthFixedMindsetAssessment />}
          />
          <Route
