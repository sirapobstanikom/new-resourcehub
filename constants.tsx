...
export const UPDATES_DATA: InnovationUpdate[] = [
  {
    id: 'update-toyota',
    title: 'Toyota Motor Europe เผยโฉมรถยนต์ไฟฟ้า FT-Se และนวัตกรรมแบตเตอรี่รุ่นใหม่',
    description: 'ก้าวสำคัญของ Toyota สู่การเป็นผู้นำด้าน Mobility ด้วยรถสปอร์ตไฟฟ้าสมรรถนะสูงและการเปลี่ยนผ่านสู่พลังงานสะอาดเต็มรูปแบบ',
    fullContent: `Toyota Motor Europe ได้เปิดตัวแนวคิดรถยนต์ไฟฟ้า (EV) รุ่นล่าสุด "FT-Se" ซึ่งเป็นรถสปอร์ตพลังงานไฟฟ้า 100% ที่ออกแบบมาเพื่อดึงดูดผู้รักความแรงและเทคโนโลยีสมัยใหม่ รถรุ่นนี้ไม่ได้เน้นแค่ความเร็ว แต่ยังมาพร้อมกับระบบปฏิบัติการ Arene ที่ช่วยปรับจูนสมรรถนะตามความต้องการของผู้ขับขี่

นอกจากตัวรถแล้ว Toyota ยังโชว์ความก้าวหน้าในเทคโนโลยีแบตเตอรี่ Solid-state ที่คาดว่าจะช่วยเพิ่มระยะทางการวิ่งได้ไกลขึ้นและลดเวลาในการชาร์จลงอย่างมาก ซึ่งจะเป็นกุญแจสำคัญในการทำให้รถยนต์ไฟฟ้าเข้าถึงผู้คนได้มากขึ้นทั่วโลก ทั้งนี้ บริษัทยังคงยึดถือแนวทาง "Multi-Pathway" เพื่อมุ่งสู่ความเป็นกลางทางคาร์บอน (Carbon Neutrality) ในยุโรปภายในปี 2040`,
  ...
  },
  {
    ...
    description: 'นวัตกรรมจัดการขยะอุตสาหกรรมด้วยการนำใบพัดกังหันลมเก่ามาสร้างเป็นโครงสร้างบ้านที่แข็งแรงและยั่งยืน',
    fullContent: `ปัญหาใหญ่ของการผลิตพลังงานลมคือ "ใบพัดกังหันลม" ที่หมดอายุการใช้งาน เนื่องจากวัสดุเป็นคอมโพสิตที่ย่อยสลายยาก ล่าสุดนักออกแบบและวิศวกรได้เสนอแนวคิด "Wind Turbine Home" โดยการนำใบพัดขนาดใหญ่มาแปรรูปเป็นส่วนประกอบของบ้าน เช่น หลังคา หรือโครงสร้างหลัก

ด้วยความที่วัสดุใบพัดกังหันลมถูกออกแบบมาให้ทนทานต่อสภาพอากาศที่รุนแรง ทำให้บ้านที่ผลิตจากวัสดุนี้มีความแข็งแรงทนทานสูงมาก และเป็นการลดปริมาณขยะอุตสาหกรรมที่ต้องถูกฝังกลบ โครงการนี้ถือเป็นตัวอย่างที่ยอดเยี่ยมของเศรษฐกิจหมุนเวียน (Circular Economy) ในภาคการก่อสร้าง`,
    image: 'https://images.unsplash.com/photo-1518005020411-38b812104c2c?q=80&w=1200&auto=format&fit=crop',
    date: 'March 2024'
  },
  {
    id: 'update-scoops',
...
ข้อดีที่เห็นได้ชัดคือนอกจากจะลดมลพิษทางอากาศแล้ว ยังลดมลพิษทางเสียง ทำให้สามารถเข้าไปจำหน่ายในสวนสาธารณะหรือย่านที่พักอาศัยได้อย่างกลมกลืน ถือเป็นโมเดลธุรกิจที่ตอบโจทย์ความยั่งยืนในอุตสาหกรรมอาหารและเครื่องดื่ม`,
    image: 'https://images.unsplash.com/photo-1567206563064-6f60f40a2b57?q=80&w=1200&auto=format&fit=crop',
    date: 'February 2024'
  },
  {
    id: 'update-self-eating',
    title: '“เฟอร์นิเจอร์” ที่กินตัวเองได้: นวัตกรรมวัสดุจากเห็ดรา (Mycelium)',
    description: 'ลืมขยะเฟอร์นิเจอร์ไปได้เลย เมื่อสิ่งของในบ้านสามารถย่อยสลายกลายเป็นปุ๋ยได้เองตามธรรมชาติหลังหมดอายุการใช้งาน',
    fullContent: `นักวิจัยด้านวัสดุศาสตร์ได้พัฒนาเฟอร์นิเจอร์จาก Mycelium หรือเส้นใยเห็ดรา ซึ่งสามารถหล่อขึ้นรูปได้ตามต้องการและมีความแข็งแรงใกล้เคียงกับไม้พลาสติก จุดเด่นคือเมื่อผู้ใช้ไม่ต้องการใช้งานแล้ว สามารถนำไปฝังดินเพื่อให้มันย่อยสลายกลายเป็นสารอาหารแก่ดินได้ทันที

กระบวนการผลิตยังใช้พลังงานน้อยกว่าพลาสติกถึง 90% และไม่มีสารพิษตกค้าง นี่คืออนาคตของการตกแต่งบ้านที่สอดคล้องกับวิถีธรรมชาติอย่างแท้จริง`,
    image: 'https://images.unsplash.com/photo-1538688593339-6278fc1ad512?q=80&w=1200&auto=format&fit=crop',
    date: 'February 2024'
  },
  {
    id: 'update-vertical-farm',
    title: 'ฟาร์มแนวตั้งในร่มแห่งแรกของโลก! ปลูกสตรอว์เบอร์รี 4 ล้านปอนด์ต่อปี',
    description: 'ปฏิวัติเกษตรกรรมด้วยฟาร์มแนวตั้งอัจฉริยะที่ใช้พื้นที่น้อยกว่า 1 เอเคอร์ แต่ให้ผลผลิตมหาศาลตลอดทั้งปี',
    fullContent: `ในรัฐเท็กซัสมีการเปิดตัวฟาร์มแนวตั้ง (Vertical Farm) ที่ใช้เทคโนโลยีควบคุมสภาพแวดล้อม (CEA) ขั้นสูง สามารถปลูกสตรอว์เบอร์รีคุณภาพสูงได้ถึง 4 ล้านปอนด์ต่อปีในพื้นที่จำกัด ระบบใช้ AI ในการควบคุมแสงสว่าง อุณหภูมิ และสารอาหาร ทำให้ไม่ต้องใช้ยาฆ่าแมลงและใช้น้ำน้อยกว่าฟาร์มปกติถึง 95%

เทคโนโลยีนี้ช่วยแก้ปัญหาความมั่นคงทางอาหารในพื้นที่จำกัด และลดระยะทางการขนส่งจากฟาร์มสู่เมือง ทำให้ผู้บริโภคได้รับผลไม้ที่สดใหม่และปลอดภัยสูง`,
    image: 'https://images.unsplash.com/photo-1523348837708-15d4a09cfac2?q=80&w=1200&auto=format&fit=crop',
    date: 'January 2024'
  },
  {
    id: 'update-solar-pc',
    title: 'Lenovo เปิดตัว “Yoga Solar PC” โน้ตบุ๊กพลังแสงอาทิตย์เครื่องแรกของโลก',
    description: 'ฉีกกฎการทำงานนอกสถานที่ด้วยโน้ตบุ๊กที่ชาร์จไฟได้จากแสงแดด พร้อมขุมพลัง AI สำหรับคนรุ่นใหม่',
    fullContent: `Lenovo สร้างเสียงฮือฮาในงาน MWC 2025 ด้วยการเปิดตัว Yoga Solar PC ที่ติดตั้งแผงโซลาร์เซลล์ประสิทธิภาพสูงไว้ที่ฝาหลัง ช่วยต่ออายุการใช้งานแบตเตอรี่ได้นานขึ้นเมื่อใช้งานกลางแจ้ง เหมาะสำหรับ Digital Nomad ที่รักอิสระ

นอกจากพลังงานสะอาดแล้ว เครื่องรุ่นนี้ยังมีชิป AI เฉพาะทางที่ช่วยจัดการพลังงานและเร่งประสิทธิภาพการทำงานให้เสถียรที่สุด ถือเป็นก้าวสำคัญของการผสานเทคโนโลยีรักษ์โลกเข้ากับไลฟ์สไตล์การทำงานยุคใหม่`,
  ...
  },
  {
    ...
    title: 'จีนเปิดตัว “แบตเตอรี่ขนาดเหรียญ” ที่ใช้ได้นาน 50 ปี โดยไม่ต้องชาร์จ',
    description: 'Betavolt เผยโศมนวัตกรรมแบตเตอรี่พลังงานนิวเคลียร์ขนาดจิ๋วที่จะเปลี่ยนโฉมสมาร์ทโฟนและอุปกรณ์การแพทย์',
    fullContent: `บริษัท Betavolt จากจีนได้เปิดตัวแบตเตอรี่ปรมาณูขนาดจิ๋ว (Betavoltaic battery) ซึ่งใช้การสลายตัวของไอโซโทปนิกเกิล-63 ผ่านชั้นเซมิคอนดักเตอร์เพชรเพื่อผลิตกระแสไฟฟ้า จุดเด่นคือมันสามารถให้พลังงานคงที่เป็นเวลา 50 ปีโดยไม่ต้องชาร์จไฟใหม่

แบตเตอรี่นี้มีความปลอดภัยสูง ทนทานต่อสภาพอากาศสุดขั้ว และย่อยสลายได้โดยไม่เป็นอันตรายต่อสิ่งแวดล้อม หากมีการนำมาใช้จริงในอนาคต เราอาจจะได้ใช้มือถือที่ไม่ต้องชาร์จแบตอีกเลยตลอดอายุการใช้งาน`,
  ...
  },
  {
    ...
    description: 'Boston Dynamics ปล่อยคลิปโชว์ความสามารถล่าสุดของ Atlas ที่สามารถเคลื่อนไหวเชิงซ้อนและทรงตัวได้ดีเยี่ยมในสถานการณ์จำลอง',
    fullContent: `Atlas หุ่นยนต์ฮิวแมนนอยด์จาก Boston Dynamics ได้ก้าวข้ามขีดจำกัดเดิมๆ ด้วยการแสดงความสามารถในการเคลื่อนไหวที่ลื่นไหลและเป็นธรรมชาติมากขึ้น ระบบการทรงตัวแบบไดนามิกช่วยให้หุ่นยนต์สามารถกระโดด วิ่ง และตีลังกาในพื้นที่ขรุขระได้

นวัตกรรมนี้ไม่ได้สร้างมาเพื่อการแสดงเท่านั้น แต่เป้าหมายหลักคือการนำไปใช้ในงานที่เสี่ยงอันตรายหรืองานกู้ภัยที่มนุษย์ไม่สามารถเข้าถึงได้ ความสำเร็จของ Atlas ถือเป็นต้นแบบสำคัญของการพัฒนาหุ่นยนต์ช่วยเหลือในอนาคต`,
  ...
  },
  {
    ...
    description: 'การรวมพลังระหว่างการแพทย์และปัญญาประดิษฐ์เพื่อช่วยตรวจหาเซลล์มะเร็งในระยะเริ่มต้นที่ตาคนอาจมองข้าม',
    fullContent: `ระบบ AI รุ่นล่าสุดที่พัฒนาโดยความร่วมมือระหว่างมหาวิทยาลัยชั้นนำและบริษัทเทคโนโลยี สามารถวิเคราะห์ภาพสแกน MRI และเนื้อเยื่อเพื่อตรวจหามะเร็งได้ด้วยความแม่นยำที่สูงกว่ารังสีแพทย์ถึง 30% ในระยะเริ่มต้น

AI นี้ถูกฝึกฝนด้วยชุดข้อมูลมหาศาล ทำให้สามารถระบุความผิดปกติเพียงเล็กน้อยได้อย่างรวดเร็ว ช่วยให้คนไข้เข้าสู่กระบวนการรักษาได้ทันท่วงที และเพิ่มโอกาสในการรอดชีวิตอย่างมีนัยสำคัญ`,
  ...
  },
  {
    ...
    description: 'หุ่นยนต์สวมใส่ (Exoskeleton) ที่ช่วยให้ผู้ป่วยอัมพฤกษ์อัมพาตสามารถกลับมาเดินและเคลื่อนไหวได้อีกครั้ง',
    fullContent: `DDL-920 เป็นนวัตกรรมหุ่นยนต์ช่วยเดินที่ออกแบบมาเพื่อผู้ป่วยโรคหลอดเลือดสมอง (Stroke) โดยเฉพาะ ระบบจะส่งสัญญาณกระตุ้นกล้ามเนื้อและช่วยพยุงน้ำหนักตามจังหวะการเดินของผู้ป่วยแต่ละคน

นอกจากช่วยในการกายภาพบำบัดแล้ว ระบบยังเก็บข้อมูลการพัฒนาของผู้ป่วยแบบ Real-time เพื่อให้แพทย์นำไปปรับแผนการรักษาได้อย่างแม่นยำ นี่คือความหวังใหม่ที่ช่วยยกระดับคุณภาพชีวิตของผู้ป่วยให้สามารถพึ่งพาตัวเองได้มากขึ้น`,
